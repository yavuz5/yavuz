...
h='YAVUZ-i'
r=input('اكتب الباسورد حك يافوز 🗿> ')
if r==h:
 print('اهلا بك في اداة المطور يافوز ✨')
else:
...
""")
print(logo) 
iid=input('\033[91m[♡]\033[94m 𝐄𝐧𝐭𝐞𝐫 𝐈𝐃 ☬ :')
tok=input('\033[91m[♕]\033[94m 𝐄𝐧𝐭𝐞𝐫 𝐓𝐨𝐤𝐞𝐧 ☬ : ')
os.system('clear')
def info(email):
    global  iid,tok
    ...
    try:
      ...
      #  print(data)
        ...
        fol=user_info['followers']
        folg=user_info['following']
        pos=user_info['posts']
        bio=user_info['bio']
...
💕𝙿𝚁𝙸𝚅𝙰𝚃𝙴 : {prv}
👽𝚅𝙴𝙳𝙾 : {pos}
✨𝙲𝙾𝚁𝚁𝙴𝙲𝚃 : {instagram.GetData(id_t).get("message").get("data")}
...
def gmail(email):
    ...
    if 'password' in response:
      ...
      {M}﴾ {F} : شغال | {M}{ge}{Z} : مو شغال | {M}{bi}{X}  : ميفيدك | {M}{gi} {M}﴿'''),sys.stdout.flush()
    else:
        be+=1
        sys.stdout.write(f'''\r
      {M}﴾ {F} : شغال | {M}{ge}{Z} : مو شغال | {M}{bi}{X}  : ميفيدك | {M}{gi} {M}﴿'''),sys.stdout.flush()
...
⠀⠀⠀⠀⠀'''
   hh= f"""{kk}
\033[1;31m━━━━━━━━━━━━━━━━━━━━
\033[2;36mGMAIL لــيسـت
\033[2;36mHOTMAIL لــيـسـت
\033[1;31m━━━━━━━━━━━━━━━━━━━━"""
...
\033[1;33mGmail 2012
\033[1;33mGmail 2013 
\033[2;36mHotmail 2011 
\033[2;36mHotmail 2012
\033[2;36mHotmail 2013 
\033[1;31m━━━━━━━━━━━━━━━━━━━━
    """
   print(hh)
   try:
...
⠀⠀⠀⠀⠀'''
    hh= f"""{kk}
\033[1;31m━━━━━━━━━━━━━━━━━━━━
\033[1;33mGMAIL صيد عشوائي
\033[1;33mHOTMAIL صيد عشوائي
\033[1;31m━━━━━━━━━━━━━━━━━━━━
    """
    print(hh)
    try:
       ii=int(input("Choice اختار شنو تريد :"))
       if ii==1:
         os.system('cls'if os.name=='nt'else'clear')
         from threading import Thread
         for i in range(25):
...
⠀⠀⠀⠀⠀'''
   hh= f"""{kk}
\033[1;31m━━━━━━━━━━━━━━━━━━━━
\033[1;33mGMAIL & HOTMAIL من لــيــسـت
\033[1;33mGMAIL & HOTMAIL صيد عشوائي
\033[1;33mOTHER THINK شئ اخر
\033[1;31m━━━━━━━━━━━━━━━━━━━━
    """
   print(hh)
   try:
       i = int(input(f'{S}Choose اختار شنو تريد? : '))
       if i ==1:
          os.system('cls'if os.name=='nt'else'clear')
          liist()
       elif i==2:
