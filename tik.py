...
print(output)
print('\n')
iid=input('\x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}  𝙄𝘿 \x1b[1;38;5;121m ๛  \x1b[38;5;117m︎')
print(' ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
tok=input('\x1b[38;5;117m{\x1b[1;32m•\x1b[38;5;117m}  \x1b[38;5;180m𝙏𝙊𝙆𝙀𝙉  \x1b[1;38;5;121m ๛   \x1b[38;5;117m')
print(' ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ ')
def info(email):
  global hit,iid,tok
  hit+=1
...
def req(email):
    ...
    if ("1023")in re:
         ...
         os.system('cls'if os.name=='nt'else'clear')
         gt+=1
         print(f"\r   {G} ﴾  {F} شغال - {HH}{M}{ge} -{Z} موشغال {HH}- {M}{bt} - {X} ميفيدك - {HH}{M}{be} {G}﴿ \r")
    else:
        os.system('cls'if os.name=='nt'else'clear')
        bt+=1
        print(f"\r     {G} ﴾  {F} شغال - {HH}{M}{ge} -{Z} موشغال {HH}- {M}{bt} - {X} ميفيدك - {HH}{M}{be} {G}﴿\r")
...
def process_user_following(user):
        try:
            ...
            while True:
                        for us in user:
                            i += 1
                            print(f"{X}Done : {M}{i}>>{S}{us}")
                            kk.append(users)
                            with open(f"yavuz.txt", '+a') as file:
                                file.write(f"{us}\n")
                            if int(i)==int(foll):exit()
...
def follwing_list():
        i=input(X+"Enter User Name : "+F)
        user=i
        process_user_following(user)
def main():
     os. system('clear') 
     print(logo) 
     admin=f"""
...
\033[1;33mGMAIL ســحــب لــيـسـت
\033[1;33mGMAIL فـحــص الـلـيـسـت
\033[1;33mDELET حــذف الــلـسـتـه
\033[1;31m━━━━━━━━━━━━━━━━━━━━
"""

     print(admin)
     try:
        ii=int(input(f'{S}Choice What You Eante : '))
        if ii==1:
               for i in range(5):
